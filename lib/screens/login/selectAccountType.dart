...
class _AccountSelect extends State<AccountSelect> {
  ...
  UpdateAccountType() async {
    ...
    userModel.type = _genderRadioBtnVal;
    await firebaseFirestore
        .collection("Users")
        .doc(user!.uid)
        .update({"Type": userModel.type});
    Fluttertoast.showToast(msg: "Account type Saved");
    Navigator.pushAndRemoveUntil(
        (context),
        MaterialPageRoute(builder: (context) => const BottomBar1()),
        (route) => false);
  }
}
