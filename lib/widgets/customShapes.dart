...
class Customshape5 extends CustomClipper<Path>{
  ...
  Path getClip(Size size) {
    ...
    path0.quadraticBezierTo(size.width*-0.1,size.height*0.6,0,size.height*0.6);
    path0.quadraticBezierTo(size.width*0.0100000,size.height*0.4,size.width*0.1,size.height*0.4);
    path0.lineTo(size.width*0.9,size.height*0.4);
    path0.quadraticBezierTo(size.width*1,size.height*0.4,size.width,size.height*0.6);
    path0.quadraticBezierTo(size.width*1,size.height*0.6,size.width,size.height);
